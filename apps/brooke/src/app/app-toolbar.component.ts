...
@Component({
	...
	@if(app.menu()) {
		<aside class="book-options">
			...
			<button type="button" title="Markdown" class="fab margin">
				<span class="icon icon-font">markdown</span>
			</button>
			<button type="button" title="Thumbnails" class="fab margin">
				<span class="icon icon-font">dataset</span>
			</button>
			<button type="button" title="Page Mode" class="fab margin">
				<span class="icon icon-font">two_pager</span>
			</button>
			<button type="button" title="Compare" class="fab margin">
